...
local mappings = {
  ...
  f = 
  {
    ...
    ["w"] = { "<cmd>Telescope grep_string theme=ivy<cr>", "Find Text under cursor" }, -- TO FIX
    ["W"] = { "<cmd>lua require('telescope').extensions.live_grep_args.live_grep_args()<cr>", "Live Grep <C-k> for extra args" },
